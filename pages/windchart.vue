...
<template>
  <section class="w-2/3 px-6 h-full border-r">
    ...
    <div class="mt-6">
      <svg id="chart" width="800" height="800" viewBox="-250 -250 500 500" @mousemove="getCoordinates" @load="calculate">
        <defs>
          <clipPath id="mask">
            <circle id="maskc" r="200" cy="0" cx="0" stroke-width="0" stroke="#000" fill="none" />
          </clipPath>
        </defs>
